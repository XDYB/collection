define([
    ...
    var MyClinicDatasetView = React.createClass({displayName: "MyClinicDatasetView",
        ...
        render: function () {
            ...
            return (
                React.createElement("div", {style: {padding: "30px 15px"}}, 
                    React.createElement("div", null, 
                        React.createElement("div", {className: "pull-right"}, 
                            React.createElement(UIClinicFilterSearch, {onUpdateDataset: $.proxy(this.handleFilterSearch, this)})
                        ), 
                        React.createElement("div", {className: "clearfix"})
                    ), 
                    React.createElement(UIDataTable, {data: this.state.data, schema: MyClinicSchemaConfig, pageConfig: this.state.pageConfig, 
